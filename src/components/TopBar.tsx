...
export default function TopBar() {
  return (
    <div className="w-full bg-slate-50 border-b border-slate-200 py-2 px-6 box-border">
      <div className="w-full max-w-7xl mx-auto flex flex-row justify-between items-center text-xs md:text-sm font-medium text-slate-600 font-sans">
        {/* Left Contacts */}
        <div className="flex items-center gap-5 md:gap-8 flex-wrap justify-start">
          <a href="tel:+919925242929" className="flex items-center gap-2 hover:text-brand-navy transition-colors no-underline">
          ...
          <a href="mailto:hr@bhaktimanagement.com" className="flex items-center gap-2 hover:text-brand-navy transition-colors no-underline">
            <svg className="w-4 h-4 text-brand-gold" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        ...
        {/* Right Tagline */}
        <div className="hidden lg:block tracking-wide text-slate-500">
